        ...
        <nav class="bg-blue-950">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-start">
                    ...
                    <div class="block ml-4 flex items-center">
                        <div class="relative">
                            @auth
                                <div class="relative w-24" id="dropdown-container">
                                    <button id="user-button" class="hover:bg-gray-900 px-3 py-2 rounded-full text-xs font-medium uppercase text-white" onclick="toggleDropdown()">
                                        {{auth()->user()->username}}
                                    </button>
                            ...
                            @else
                                ...
                                <a href="/login" class="ml-2 text-xs font-bold uppercase {{ request()->is('login') ? 'text-blue-500' : 'text-white' }}">Log In</a>
                            @endauth
                        </div>
                    </div>
                </div>
